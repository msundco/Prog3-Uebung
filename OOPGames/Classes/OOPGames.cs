...
namespace OOPGames
{
    ...
    public class MoveKeyboardSelection : IMoveSelectionKeyboard
    {
        Key _Key;

        public MoveKeyboardSelection(Key key)
        {
            _Key = key;
        }
        ...
        public int XClickPos { get { return -1; } }

        public int YClickPos { get { return -1; } }
    }
}
